...
export default function ContactUs () {
  ...
  <h2 className="text-align-center text-3xl font-bold text-gray-700 flex justify-center pt-12">Meet the Team!</h2>
...
<div class="max-w-sm rounded overflow-hidden shadow-lg pt-12 pb-20">
  <img class="w-full" src="client\src\assets\imgs\RDM wedding edit.jpg" alt="Ryan Mennemeier self"/>
  <div class="px-6 py-4">
